...
@CucumberOptions(
        plugin = {"json:target/runnerClass/cucumber.json", "pretty", "html:target/runnerClass/cucumber.html","com.cucumber.listener.ExtentCucumberFormatter"},
        features = "src/test/resources/features/",
        glue = "steps",
        tags = "@used-CarSearch, @searchCar"
